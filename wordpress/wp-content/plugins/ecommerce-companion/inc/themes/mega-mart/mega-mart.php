...
require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/mega-mart/features/mega-mart-slider.php';
...
if ( ! function_exists( 'ecommerce_comp_mega_mart_frontpage_sections' ) ) :
	function ecommerce_comp_mega_mart_frontpage_sections() {	
		 require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/mega-mart/sections/section-slider.php';
		 require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/mega-mart/sections/section-category.php';
		 require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/mega-mart/sections/section-info.php';
	...
	add_action( 'mega_mart_sections', 'ecommerce_comp_mega_mart_frontpage_sections' );
endif;