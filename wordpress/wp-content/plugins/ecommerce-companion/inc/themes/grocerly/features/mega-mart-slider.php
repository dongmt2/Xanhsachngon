...
//Left Content	
	...
	$wp_customize->add_setting( 
		'left_side_img'.$i , 
		array(
			'default'			=> esc_url(ECOMMERCE_COMP_PLUGIN_URL . 'inc/themes/grocerly/assets/images/page-slider/banner'.$i.'.jpg'),
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'mega_mart_sanitize_url',
		) 
	);

	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize , 'left_side_img'.$i ,
		array(
...
//Right Content	
	...
	$wp_customize->add_setting( 
		'right_side_title'.$i , 
			array(
			'default' => __('Exclusive Offer!','ecommerce-companion'),
			'capability'     => 'edit_theme_options',
			'sanitize_callback' => 'mega_mart_sanitize_text',
		) 
	);
	...
	$wp_customize->add_setting( 
		'right_side_subtitle'.$i , 
			array(
			'default' => __('Hot Spicy Items','ecommerce-companion'),
			'capability'     => 'edit_theme_options',
			'sanitize_callback' => 'mega_mart_sanitize_text',
		) 
	);
