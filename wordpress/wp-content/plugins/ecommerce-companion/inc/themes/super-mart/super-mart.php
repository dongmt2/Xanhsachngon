...
require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/super-mart/theme-functions/extras.php';
...
require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/super-mart/features/mega-mart-slider.php';
...
require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/super-mart/features/mega-mart-testimonial.php';
...
if ( ! function_exists( 'ecommerce_comp_super_mart_frontpage_sections' ) ) :
	function ecommerce_comp_super_mart_frontpage_sections() {	
		require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/super-mart/sections/section-slider.php';
		require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/mega-mart/sections/section-category.php';
		require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/super-mart/sections/section-info.php';
		...
		require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/super-mart/sections/section-testimonial.php';
    }
