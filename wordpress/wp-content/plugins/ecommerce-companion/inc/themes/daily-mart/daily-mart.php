...
require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/daily-mart/theme-functions/dynamic_style.php';
...
require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/daily-mart/features/mega-mart-slider.php';
...
require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/daily-mart/features/mega-mart-brand.php';
...
if ( ! function_exists( 'ecommerce_comp_daily_mart_frontpage_sections' ) ) :
	function ecommerce_comp_daily_mart_frontpage_sections() {	
		require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/daily-mart/sections/section-slider.php';
		require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/mega-mart/sections/section-category.php';
		require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/daily-mart/sections/section-info.php';
		...
		require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/daily-mart/sections/section-brand.php';
    }
	add_action( 'mega_mart_sections', 'ecommerce_comp_daily_mart_frontpage_sections' );
endif;