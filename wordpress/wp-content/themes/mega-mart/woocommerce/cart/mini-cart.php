				...
				<div class="cart-product woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						...
						sprintf(
							...
							esc_attr( sprintf( __( 'Remove %s from cart', 'mega-mart' ), wp_strip_all_tags( $product_name ) ) ),
							esc_attr( $product_id ),
	...
	<div class="cart-footer">
		<div class="cart-ft-totals">
			<div class="cart-ft-amt cart-ft-amt-subtotal ">
				<span class="cart-ft-amt-label"><?php echo esc_html_e('Subtotal','mega-mart'); ?></span>
		...
		<div class="cart-ft-buttons-cont bt">
			<a href="<?php echo esc_url(wc_get_cart_url()); ?>" class="cart-ft-btn button btn btn-primary cart-ft-btn-cart cta-01"><?php echo esc_html_e('View Cart','mega-mart'); ?></a>
			<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="cart-ft-btn button btn btn-border-secondary cart-ft-btn-checkout cta-02"><?php echo esc_html_e('Checkout','mega-mart'); ?></a>
		</div>
	</div>
...
<?php else : ?>
	...
	<p class="woocommerce-mini-cart__empty-message"><?php esc_html_e( 'No products in the cart.', 'mega-mart' ); ?></p>
				...
				<div class="cart-product woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						...
						sprintf(
							'<div class="cart-img-col"><a href="%s" class="remove remove_from_cart_button" aria-label="%s" data-product_id="%s" data-cart_item_key="%s" data-product_sku="%s">&times;</a><a href='.esc_url( $product_permalink ).'>'."$thumbnail".'</a></div>',
							esc_url( wc_get_cart_remove_url( $cart_item_key ) ),
							esc_attr__( 'Remove this item', 'mega-mart' ),
							esc_attr( $product_id ),
							esc_attr( $cart_item_key ),
							esc_attr( $_product->get_sku() )
						),
