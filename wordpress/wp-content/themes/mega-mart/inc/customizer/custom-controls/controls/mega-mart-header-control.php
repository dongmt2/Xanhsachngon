<?php
class Mega_Mart_Header_Customize_Control extends WP_Customize_Control {
	public $type = 'header_type';

		   function render_content()
		   
		   {
		    echo '<h3>' .  __( 'Select Header', 'mega-mart' ) . '</h3>';
			  ...
			  foreach($this->choices as $key => $value ) {
				?>
				   <label>
					...
					<img <?php if($this->value() == $key){ echo 'class="header_type"'; } ?> src="<?php echo esc_url(get_template_directory_uri()); ?>/inc/customizer/assets/images/header/mega-mart-header-<?php echo $value; ?>" alt="<?php echo esc_attr( $value ); ?>" />
					</label>
