...
require MEGA_MART_PARENT_INC_DIR . '/customizer/custom-controls/controls/font-selector/class/class-font-selector.php';
/**
 * List of standard fonts
 */
function mega_mart_font_selector_get_standard_fonts() {
	return apply_filters(
		'mega_mart_font_selector_standard_fonts_array', array(
 ...
 * @since 1.1.38
 */
function mega_mart_font_selector_enqueue_google_font( $font ) {

	// Get list of all Google Fonts
	$google_fonts = mega_mart_font_selector_get_google_fonts_array();
	...
	$subsets = apply_filters( 'mega_mart_font_subsets', array( 'latin' ) );
	if ( ! empty( $subsets ) ) {
		$font_subsets = array();
	...
	$weights = apply_filters( 'mega_mart_font_weights', array( '300', '400', '500', '700' ) );
