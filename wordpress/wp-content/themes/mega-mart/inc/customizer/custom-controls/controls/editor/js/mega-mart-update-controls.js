            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if(result !== '' && result !== 'undefined' ){
                        ...
                        jQuery( '#Mega_Mart_Page_Editor' ).val(content);
                        WPEditorWidget.setEditorContent('Mega_Mart_Page_Editor');
                        ...
                        if(result.post_thumbnail !== '' && result.post_thumbnail !== 'undefined'){
                            ...
                            var html = '<label for="mega_mart_feature_thumbnail-button">' +
                                ...
                                '<button type="button" class="button upload-button control-focus" id="mega_mart_feature_thumbnail-button">Change Image</button> ' +
