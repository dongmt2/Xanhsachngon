 ...
 * @access public
 */
class Mega_Mart_Customizer_Range_Control extends WP_Customize_Control {
	...
	/**
	 * Mega_Mart_Customizer_Range_Control constructor.
	 *
 ...
 */
function mega_mart_sanitize_range_value( $input ) {
	if ( mega_mart_is_json( $input ) ) {
 ...
 * @param  string $string Input.
 */
function mega_mart_is_json( $string ) {
	return is_string( $string ) && is_array( json_decode( $string, true ) ) ? true : false;
}
