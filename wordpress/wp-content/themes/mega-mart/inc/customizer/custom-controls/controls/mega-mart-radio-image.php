...
/**
 * Mega_Mart
 * Customizer Control: Mega_Mart Radio Image control
 */

class Mega_Mart_Customize_Control_Radio_Image extends Mega_Mart_Customize_Base_Control {
	/**
	 ...
	 * @var   string
	 */
	public $type = 'mega-mart-radio-image';
	/**
	...
	public function render_content() {
		...
		<div id="<?php echo esc_attr( "input_{$this->id}" ); ?>" class="mega-mart-radio-image-select">
