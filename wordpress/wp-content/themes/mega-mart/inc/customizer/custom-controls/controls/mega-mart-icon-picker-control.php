 ...
 * @package     Mega_Mart
 * @author      Mega_Mart
 * @copyright   Copyright (c) 2022, Mega_Mart
 * @since       1.0
 */
...
class Mega_Mart_Icon_Picker_Control extends WP_Customize_Control
{

  private $icons = false;

  public function __construct( $manager, $id, $args = array(), $options = array() ) {
    $this->icons = $this->Mega_Mart_get_icons();
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'mega-mart-icon-picker-css', MEGA_MART_PARENT_URI . '/assets/fonticonpicker/jquery.fonticonpicker.min.css', false );
			 
		wp_enqueue_script( 'mega-mart-icon-picker-js', MEGA_MART_PARENT_URI .'/assets/fonticonpicker/jquery.fonticonpicker.min.js', array( 'jquery', 'jquery-ui-sortable' ) );
	}
