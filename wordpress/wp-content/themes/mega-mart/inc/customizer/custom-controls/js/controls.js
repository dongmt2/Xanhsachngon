 ...
 */
	...
	wp.customize.controlConstructor['mega-mart-sortable'] = wp.customize.Control.extend({
...
/**
 *Mega_Mart Radio Image
 */
 
jQuery( document ).ready( function() {
	jQuery( '.customize-control-mega-mart-radio-image' ).buttonset();
} );
