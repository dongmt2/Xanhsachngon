 ...
 */
function mega_mart_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function mega_mart_sanitize_html( $html ) {
 ...
 */
function mega_mart_sanitize_number_absint( $number, $setting ) {
 ...
 */
function mega_mart_sanitize_select( $input, $setting ) {
 ...
 */
function mega_mart_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function mega_mart_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function mega_mart_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}