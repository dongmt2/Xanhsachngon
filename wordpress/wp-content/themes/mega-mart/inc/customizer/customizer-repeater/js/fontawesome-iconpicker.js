(function ($) {
    'use strict';
    wp.mega_mart_pro_customizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                mega_mart_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.mega_mart_pro_customizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.mega_mart_pro_customizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.mega_mart_pro_customizerRepeater.iconPickerToggle($(this));
        });
