...
class Popularis_Customizer_Notice {
	...
	public function setup_config() {
		...
		$popularis_ecommerce_recommended_plugins = array();
		
		if ( isset( $this->recommended_plugins ) ) {
			$popularis_ecommerce_recommended_plugins = $this->recommended_plugins;
		}
	...
	public function scripts_for_customizer() {
		...
		wp_localize_script(
			'popularis-customizer-notice', 'customizer_notice_data', array(
				...
				'base_path'                => admin_url(),
				'activating_string'        => esc_html__( 'Activating', 'popularis-ecommerce' ),
			)
		);
	...
	public function dismiss_recommended_plugins_callback() {
		...
		if ( ! empty( $action_id ) ) {
			...
			update_option( 'popularis_ecommerce_show_recommended_plugins', $show_recommended_plugins );
		}
